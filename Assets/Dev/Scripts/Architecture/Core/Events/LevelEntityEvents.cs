...
public static class RegistryEvents
{
    ...
    public static event Action<Vector2Int, ISensor> OnSensorRegistry; // Event
    public static void NotifySensorRegistry(Vector2Int cell, ISensor sensor) // Fonction Call
