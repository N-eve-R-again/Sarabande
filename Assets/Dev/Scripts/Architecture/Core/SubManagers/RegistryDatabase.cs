...
public class RegistryDatabase
{
    ...
    //SENSORS GET SET
    public ISensorExtension GetSensorExtensionByCell(Vector2Int cell)
    {
        if (sensorExtensions.TryGetValue(cell, out ISensorExtension sensor)) return sensor;
        return null;
    }

    public void SetSensorExtension(Vector2Int cell, ISensorExtension sensor) => sensorExtensions[cell] = sensor;
